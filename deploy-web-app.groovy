pipeline{
    ...
    stages{
        ...
        stage("tag image"){
            steps{
                sh "docker tag web-app-image:latest 663839140840.dkr.ecr.ap-south-1.amazonaws.com/python-web-app:latest"
            }
        }
        stage("push to ecr"){
            steps{
                sh "docker push 663839140840.dkr.ecr.ap-south-1.amazonaws.com/python-web-app:latest"
            }
        }
